...
// end include: /tmp/tmpdiq6wjn_.js
// include: /tmp/tmpm186g_au.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpm186g_au.js
// include: /tmp/tmp71srk83s.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp71srk83s.js
...
var ASM_CONSTS = {
  149016: () => { if (document.fullscreenElement) return 1; },  
 149062: () => { return document.getElementById('canvas').width; },  
 149114: () => { return parseInt(document.getElementById('canvas').style.width); },  
 149182: () => { document.exitFullscreen(); },  
 149209: () => { setTimeout(function() { Module.requestFullscreen(false, false); }, 100); },  
 149282: () => { if (document.fullscreenElement) return 1; },  
 149328: () => { return document.getElementById('canvas').width; },  
 149380: () => { return screen.width; },  
 149405: () => { document.exitFullscreen(); },  
 149432: () => { setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { canvas.style.width="unset"; }, 100); }, 100); },  
 149565: () => { return window.innerWidth; },  
 149591: () => { return window.innerHeight; },  
 149618: () => { if (document.fullscreenElement) return 1; },  
 149664: () => { return document.getElementById('canvas').width; },  
 149716: () => { return parseInt(document.getElementById('canvas').style.width); },  
 149784: () => { if (document.fullscreenElement) return 1; },  
 149830: () => { return document.getElementById('canvas').width; },  
 149882: () => { return screen.width; },  
 149907: () => { return window.innerWidth; },  
 149933: () => { return window.innerHeight; },  
 ...
 150083: () => { document.exitFullscreen(); },  
 150110: () => { if (document.fullscreenElement) return 1; },  
 150156: () => { return document.getElementById('canvas').width; },  
 150208: () => { return parseInt(document.getElementById('canvas').style.width); },  
 150276: () => { document.exitFullscreen(); },  
 150303: ($0) => { document.getElementById('canvas').style.opacity = $0; },  
 150361: () => { return screen.width; },  
 150386: () => { return screen.height; },  
 150412: () => { return window.screenX; },  
 150439: () => { return window.screenY; },  
 150466: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 150519: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 150590: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 150647: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 150903: ($0) => { document.getElementById('canvas').style.cursor = UTF8ToString($0); },  
 150974: () => { if (document.fullscreenElement) return 1; },  
 151020: () => { return window.innerWidth; },  
 151046: () => { return window.innerHeight; },  
 151073: () => { if (document.pointerLockElement) return 1; }
};
...
var dynCall_fifii = makeInvalidEarlyAccess('dynCall_fifii');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['dynCall_fifii'] != 'undefined', 'missing Wasm export: dynCall_fifii');
  ...
  dynCall_fifii = dynCalls['fifii'] = createExportWrapper('dynCall_fifii', 5);
